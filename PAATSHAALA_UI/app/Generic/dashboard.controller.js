angular.module('eduApp').controller('DashboardController',DashboardController);

DashboardController.$inject = ['$scope', '$location', 'serviceFactory', 'commonDataFactory'];

function DashboardController($scope, $location, serviceFactory, commonDataFactory) {
